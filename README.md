...
### 🤖 Medical RAG Chatbot
🔗 [Repo](https://github.com/YASSINEBOULGUANT/medical-rag-chatbot)  
...
🔗 [Repo](https://github.com/YASSINEBOULGUANT/airline-customer-satisfaction)  

End-to-end ML pipeline to predict airline customer satisfaction using Kaggle datasets, deployed on Azure.

### 🧠 Brain Tumor Classifier
🔗 [Repo](https://github.com/YASSINEBOULGUANT/brain-tumor-classifier)  
...
## 📫 Let's Connect
💼 LinkedIn: [Lien](https://www.linkedin.com/in/yassine-b-538b44399/)  
